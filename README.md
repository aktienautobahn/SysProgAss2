...
```
cd existing_repo
git remote add origin https://git.tu-berlin.de/sysprog24/sysprog-ha2-v.1.5.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.tu-berlin.de/sysprog24/sysprog-ha2-v.1.5/-/settings/integrations)
